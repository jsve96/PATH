...
from . import utils as _diffusion_utils
from .utils import get_beta_scheduler, get_loss_weighting, PositionalEncoding, FeedForward
...
class DiffusionModule(LightningModule):
    def __init__(
        ...
        **kwargs,
        ...
        self.diffusion = getattr(_diffusion_utils, diffusion)(
            dim=dim,
