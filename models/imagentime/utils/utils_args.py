...
def parse_args_uncond():
    ...
    parser.add_argument('--gpu', type=int, default=None, help='GPU index to use (e.g. 0, 1). Defaults to first available CUDA device.')
    ...
    parser.add_argument('--dataset',
                        choices=['kdd_cup', 'traffic_hourly', 'solar_weekly', 'temperature_rain',
                                 'nn5_daily', 'fred_md', 'sine', 'energy', 'mujoco', 'stocks','air','eye','ecg'], help='training dataset')
    ...
    if parsed_args.dataset in ['stock', 'sine', 'energy', 'mujoco','air']:
...
def parse_args_cond():
    ...
    parser.add_argument('--dataset',
                        choices=['kdd_cup', 'traffic_hourly', 'solar_weekly', 'temperature_rain',
                                 'nn5_daily', 'fred_md', 'sine', 'energy', 'mujoco', 'stocks','air','eye'], help='training dataset')
